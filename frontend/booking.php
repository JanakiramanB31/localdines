  ...
  <head>
    ...
    <!-- =======================================================
      ...
      * License: https://bootstrapmade.com/license/
      ...
      ======================================================== -->
    <link href="<?php echo API_BOOKING_URL.'/core/framework/libs/pj/css/pj.bootstrap.min.css'; ?>" type="text/css" rel="stylesheet" />
   	<link href="<?php echo API_BOOKING_URL.'/index.php?controller=pjFront&action=pjActionLoadCss';?>" type="text/css" rel="stylesheet" />
    <meta name="google-signin-client_id" content="750038061970-or4c1v4uqtnfbi4vj0ohg07fiuhvhp5o.apps.googleusercontent.com" >
  </head>
  <body>
   <script type="text/javascript" src=<?php echo API_BOOKING_URL.'/index.php?controller=pjFront&action=pjActionLoad' ?>></script>
