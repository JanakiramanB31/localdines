...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "115");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.0.2");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "food_delivery_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjBase', 'pjAuth', 'pjInstaller', 'pjVouchers', 'pjPayments', 'pjPaypal', 'pjAuthorize', 'pj2checkout', 'pjBraintree', 'pjMollie', 'pjPaypalExpress', 'pjSkrill', 'pjStripe', 'pjWorldPay');
...
$CONFIG['listing_actions'] = array(
    ...
    'pjAdminOrders_pjActionIndex' => 'pjAdminOrders_pjActionGetOrder',
    'pjAdminClients_pjActionIndex' => 'pjAdminClients_pjActionGetClient',
    'pjAdminProducts_pjActionIndex' => 'pjAdminProducts_pjActionGetProduct',
    'pjAdminCategories_pjActionIndex' => 'pjAdminCategories_pjActionGetCategory',
    'pjAdminExtras_pjActionIndex' => 'pjAdminExtras_pjActionGetExtra',
    'pjAdminLocations_pjActionIndex' => 'pjAdminLocations_pjActionGetLocation',
    'pjAdminReviews_pjActionIndex' => 'pjAdminReviews_pjActionGetReviews',
);
